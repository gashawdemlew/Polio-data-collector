...
//     return Scaffold(
//       appBar: AppBar(title: const Text('Review Data')),
...
//               else ...[
//                 const Text('Review your data'),
//                 const SizedBox(height: 20),
//                 ListTile(
//                     title: const Text('Epidemic Number'),
//                     subtitle: Text(widget.epid_number)),
//                 ListTile(
//                     title: const Text('Gender'), subtitle: Text(widget.gender)),
//                 ListTile(
//                     title: const Text('Date of Birth'),
//                     subtitle: Text(widget.dateofbirth)),
//                 ListTile(
//                     title: const Text('Zone'), subtitle: Text(widget.zone)),
//                 ListTile(
//                     title: const Text('Region'), subtitle: Text(widget.region)),
//                 ListTile(
//                     title: const Text('Woreda'), subtitle: Text(widget.woreda)),
//                 ListTile(
//                     title: const Text('Fever At Onset'),
//                     subtitle: Text(widget.feverAtOnset)),
//                 ListTile(
//                     title: const Text('Flaccid Paralysis'),
//                     subtitle: Text(widget.flaccidParalysis)),
//                 ListTile(
//                     title: const Text('Paralysis Progressed'),
//                     subtitle: Text(widget.paralysisProgressed)),
//                 ListTile(
//                     title: const Text('Asymmetric'),
//                     subtitle: Text(widget.asymmetric)),
//                 ListTile(
//                     title: const Text('Site of Paralysis'),
//                     subtitle: Text(widget.siteOfParalysis)),
//                 ListTile(
//                     title: const Text('Total OPV Doses'),
//                     subtitle: Text(widget.totalOPVDoses.toString())),
//                 ListTile(
//                     title: const Text('Admitted to Hospital'),
//                     subtitle: Text(widget.admittedToHospital)),
//                 ListTile(
//                     title: const Text('Date of Admission'),
//                     subtitle: Text(widget.dateOfAdmission)),
//                 ListTile(
//                     title: const Text('Medical Record No'),
//                     subtitle: Text(widget.medicalRecordNo)),
//                 ListTile(
//                     title: const Text('Facility Name'),
//                     subtitle: Text(widget.facilityName)),
//                 ListTile(
//                     title: const Text('Date Stool 1'),
//                     subtitle: Text(widget.dateStool1)),
//                 ListTile(
//                     title: const Text('Date Stool 2'),
//                     subtitle: Text(widget.dateStool2)),
//                 ListTile(
//                     title: const Text('Days After Onset'),
//                     subtitle: Text(widget.daysAfterOnset)),
//                 ListTile(
//                     title: const Text('Stool 1 Date Collected'),
//                     subtitle: Text(widget.stool1DateCollected)),
//                 ListTile(
//                     title: const Text('Stool 2 Date Collected'),
//                     subtitle: Text(widget.stool2DateCollected)),
//                 ListTile(
//                     title: const Text('Stool 1 Days After Onset'),
//                     subtitle: Text(widget.stool1DaysAfterOnset)),
//                 ListTile(
//                     title: const Text('Stool 1 Date Sent to Lab'),
//                     subtitle: Text(widget.stool1DateSentToLab)),
//                 ListTile(
//                     title: const Text('Stool 2 Date Sent to Lab'),
//                     subtitle: Text(widget.stool2DateSentToLab)),
//                 ListTile(
//                     title: const Text('Stool 1 Date Received by Lab'),
//                     subtitle: Text(widget.stool1DateReceivedByLab)),
//                 ListTile(
//                     title: const Text('Stool 2 Date Received by Lab'),
//                     subtitle: Text(widget.stool2DateReceivedByLab)),
//                 ListTile(
//                     title: const Text('Case or Contact'),
//                     subtitle: Text(widget.caseOrContact)),
//                 ListTile(
//                     title: const Text('Specimen Condition'),
//                     subtitle: Text(widget.specimenCondition)),
//                 ListTile(
//                     title: const Text('Stool 2 Days After Onset'),
//                     subtitle: Text(widget.stool2DaysAfterOnset)),
//                 ListTile(
//                     title: const Text('Residual Paralysis'),
...
//                     subtitle: Text(widget.last_name)),
//                 ListTile(
//                     title: const Text('Phone No'),
//                     subtitle: Text(widget.phoneNo)),
//                 ElevatedButton(
//                   onPressed: () async {
