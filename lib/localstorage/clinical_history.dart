...
// class ClinicalHistoryForm1 extends StatefulWidget {
...
// class _ClinicalHistoryFormState extends State<ClinicalHistoryForm1> {
...
//     setState(() {
//       epid_number = prefs.getString('epid_number') ?? '';
//       last_name = prefs.getString('names') ?? '';
//       first_name = prefs.getString('last_name') ?? '';
//       phoneNo = prefs.getString('phone_no') ?? '';
//       gender = prefs.getString('gender');
//       dateofbirth = prefs.getString('date_of_birth') ?? '';
//       region = prefs.getString('selected_region');
//       zone = prefs.getString('selected_zone');
//       woreda = prefs.getString('selected_woreda');
//     });
//   }
